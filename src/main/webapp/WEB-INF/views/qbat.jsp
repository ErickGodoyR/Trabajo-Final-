        ...
        <table id="tblproducto"class="table table-cell-padding-x-sm: .18rem table-cell-padding-y-sm: .18rem">
            ...
            <c:forEach var="p" items="${producto}">
                ...
                <div class="card" style="width: 18rem;">
                  ...
                  <li class="list-group-item">Detalle: <c:out value="${p.getNombre()}"></c:out></li>
                    <li class="list-group-item">Detalle: <c:out value="${p.getDetalle()}"></c:out></li>
                    <li class="list-group-item">Precio: <c:out value="${p.getPrecio()}"></c:out></li>
                    <li class="list-group-item">Stock: <c:out value="${p.getStock()}"></c:out></li>
                    <li class="list-group-item">
                        <label for="stock" class="form-label">UND</label>
                        <input type="number"  min="0" class="form-control" id="ctda_baterias" name="ctda_baterias" placeholder="Ingrese cantidad" value="" required>
                    </li>
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/producto/edit/${p.getId()}" id="guardar" class="btn btn2 btn-outline-primary" type="submit" >Agregar a Carrito<i class="fas fa-cart-plus"></i></a></li>
                  </ul>
                </div>
