        ...
        <input type="hidden" name="id" id="id" value="${producto.getId()}">
			...
			<div class="row mt-4">
    			<div class="col align-self-start col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <label for="idcategoria" class="form-label">sku</label>
                ...
                <div class="col align-self-start col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    ...
                    <input type="text" class="form-control" id="marca" name="marca" placeholder="Ingresar sku" value="${producto.getMarca()}" required>
                </div>
    			</div>
   			 	<div class="col align-self-end col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <label for="nombre" class="form-label">nombre</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingresa Marca" value="${producto.getNombre()}" required>
    			</div>
  			</div>
