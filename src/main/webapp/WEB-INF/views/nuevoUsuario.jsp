...
<div class="row mt-4">
   ...
   <div class="col align-self-center">
           ...
           <!-- <input type="text" class="form-control" id="habilitado" name="habilitado" placeholder="password" value="${usuario.getPassword()}" required> -->
          <select id="habilitado" class="form-select" name="habilitado">
              <option value="true" ${usuario.getHabilitado() == "true" ? 'selected': ''}>true</option>
            <!--  <option value="true" ${usuario.getHabilitado() == "true" ? 'selected': ''}>false</option> -->
          </select>
   </div>
...
<div class="row mt-4">
   ...
   <div class="col align-self-end">
			...
			<div class="row mt-4">
    			...
    			<div class="col align-self-center">
                     <button class="btn btn-primary" type="submit" id="guardar_usuario">Guardar</button>
